...
2. [Download](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html) and drop the Oracle JDK 8u72 RPM 64bit file **jdk-8u72-linux-x64.rpm** in this folder

	Linux x64       153 MB        jdk-8u72-linux-x64.rpm
